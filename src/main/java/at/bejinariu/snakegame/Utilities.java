...
public class Utilities {
     ...
     * Aufzeigen von aufgetretenen Ereignissen wÃ¤hrend des Programmablaufs
    ...
    private static void showMessage(String title, String headerMessage, String message, Alert.AlertType type, Image icon, boolean expanded, boolean wrap, Double fixedWindowWidth) {
        ...
        alert.getDialogPane().getStylesheets().add("file:src/main/resources/styles/styleUtilities.css");
    ...
    public static ButtonType showYesNoDialog(String text, String title, Alert.AlertType windowtype, Image icon) {
